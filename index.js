...
let swiperTestimonial = new Swiper(".testimonial__container", {
    ...
    /* grabCursor to slide each testimonial with slide */
    grabCursor: true,
    spaceBetween: 48,
...
function scrollHeader() {
    ...
    if (this.scrollY >= 80) {
        nav.classList.add('scoll-header');
    } else {
...
if (selectedTheme) {
    // If the validation is fulfilled, we ask what the issue was to know if we acticaated or deactivated the dark theme
